...
// Deprecated: Use GetMessagesByGroupRequest.ProtoReflect.Descriptor instead.
...
var file_proto_v2_chat_proto_goTypes = []any{
	(*User)(nil),                      // 0: v2.User
	(*Message)(nil),                   // 1: v2.Message
	(*CreateUserRequest)(nil),         // 2: v2.CreateUserRequest
	(*GetUserRequest)(nil),            // 3: v2.GetUserRequest
	(*CreateMessageRequest)(nil),      // 4: v2.CreateMessageRequest
	(*GetMessagesByGroupRequest)(nil), // 5: v2.GetMessagesByGroupRequest
	(*timestamppb.Timestamp)(nil),     // 6: google.protobuf.Timestamp
}
var file_proto_v2_chat_proto_depIdxs = []int32{
	6, // 0: v2.User.created_at:type_name -> google.protobuf.Timestamp
	6, // 1: v2.User.updated_at:type_name -> google.protobuf.Timestamp
	6, // 2: v2.Message.created_at:type_name -> google.protobuf.Timestamp
	2, // 3: v2.UserService.CreateUser:input_type -> v2.CreateUserRequest
	3, // 4: v2.UserService.GetUser:input_type -> v2.GetUserRequest
	4, // 5: v2.MessageService.CreateMessage:input_type -> v2.CreateMessageRequest
	5, // 6: v2.MessageService.GetMessagesByGroup:input_type -> v2.GetMessagesByGroupRequest
	0, // 7: v2.UserService.CreateUser:output_type -> v2.User
	0, // 8: v2.UserService.GetUser:output_type -> v2.User
	1, // 9: v2.MessageService.CreateMessage:output_type -> v2.Message
	1, // 10: v2.MessageService.GetMessagesByGroup:output_type -> v2.Message
